...
public class UVLFormulaFormatTest extends Common {
    ...
    void testFixtures2() {
        ...
        // FormatTest.testSerializeAndParse(getFormula("ABC-nAnBnC"), new
        // UVLFormulaFormat(),
        // Expressions::print);
    }
    ...
    void testUVLFormulaFormatSerialize() throws IOException {
        IFormula formula = new Reference(new Or(
    ...
    void testUVLFormulaFormatParse() throws IOException {
        final Result<IFormula> result = IO.load(
                Path.of("src", "test", "resources", "uvl", "formulaSerializeResult.uvl"), new UVLFormulaFormat());
